...
namespace CSMyBatisBuilder
{
    ...
    public class TableBuilder
    {
        ...
        public  IList<ColumnSchema> columns {get ;private set;}
        public  IList<ColumnSchema> pkColumns {get ;private set;}
        public  IList<ColumnSchema> nonPkColumns {get ;private set;}
        public  IList<ColumnSchema> finderColumns {get ;private set;}
        public  IList<ColumnSchema> lobColumns {get ;private set;}
        public  IList<ColumnSchema> nonLobColumns {get ;private set;}
        
        
         public TableBuilder(TableSchema sourceTable){
        ...
        public TableBuilder(TableSchema sourceTable, ITableBuilderOption builderOption){
           if (sourceTable == null) throw new ArgumentNullException("sourceTable");
             ...
             pkColumns =  new List<ColumnSchema>();
             nonPkColumns =  new List<ColumnSchema>();
             finderColumns =  new List<ColumnSchema>();
             lobColumns =  new List<ColumnSchema>();
             nonLobColumns =  new List<ColumnSchema>();
            
            
            
            bool isSingleColumnPk = sourceTable.PrimaryKey.MemberColumns.Count == 1;
            
           entityName =  GetEntityName(sourceTable.Name, builderOption.entityOption);
        
         //  entityFullName =  CSHelper.GetQualifiedName(EntityName, entityNamespace)
  ...
  public class TableTemplate : CodeTemplate
  {
      ...
      protected override void OnPreRender()
        {
            if (builder == null)
            {
                builder = new TableBuilder(sourceTable);
    ...
    public static class CSHelper
    {
        ...
        {
            char[] delimiters = { '_', ' ' };
            string[] parts = s.ToLower().Split(delimiters);
            string result = "";
